...
| `.env` (FACTBOT*\*, DEEPSEEK*_, META\__, IG\_\*)          | ✅ Terisi di lokal — tinggal salin + tambah field VPS          |
...
_Dokumen ini = runbook eksekusi. Teori & arsitektur detail: `docs/DEPLOY_VPS.md`._
_Deadline 16 Agt 2026 — jalur kritis: Langkah 1-4 selesai dalam 1 sesi, Langkah 5 (matikan lokal) setelah E2E terbukti._
